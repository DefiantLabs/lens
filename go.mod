...
require (
	...
	github.com/tendermint/tm-db v0.6.7 // indirect; indirect, was 0.6.7
...
replace github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.45.1-0.20220611234148-f59c62f19567
